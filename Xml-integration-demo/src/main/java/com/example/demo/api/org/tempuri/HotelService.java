...
@WebServiceClient(name = "HotelService", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://api.tboholidays.com/HotelAPI_V7/HotelService.svc?wsdl")
public class HotelService extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://api.tboholidays.com/HotelAPI_V7/HotelService.svc?wsdl");
